...
(function(definition) {
    ...
    "use strict";
    var prototype, regex = new RegExp("(.+?).(jpg|jpeg|png|gif|webp)$"), mDomElement = modules["dom/element"], mComponentSense = modules["component/sense"], storage = [];
    ...
    mDomElement.create(window).on("resize orientationchange", function() {
        var i = 0, instance;
