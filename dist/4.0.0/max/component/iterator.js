...
(function(undefined) {
    "use strict";
    var o_dp = Object.defineProperty, gcd = function(value, writable) {
        return {
            writable: !!writable,
            configurable: false,
            enumerable: false,
    ...
    function definition(Emitter, functionMerge, functionUniqueUuid) {
        ...
        function Iterator(data, settings) {
            var self = this.super.call(this), uuid = self.uuid;
        ...
        Iterator.prototype = {
            setData: function(data) {
                var self = this, uuid, properties, settings;
            ...
            seek: function(index) {
                var self = this, properties = storage[self.uuid];
            ...
            previous: function() {
                var self = this, uuid = self.uuid, properties = storage[uuid], settings = properties.settings, index;
